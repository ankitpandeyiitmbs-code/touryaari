...
export default function Navbar() {
  ...
  return (
    <header
      className="fixed top-0 left-0 right-0 z-50 bg-[#4A7C59] shadow-[0_1px_0_rgba(200,144,51,0.2)] transition-all duration-400"
    >
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            ...
            className="fixed inset-0 top-0 bg-[#4A7C59] z-50 lg:hidden"
          >
