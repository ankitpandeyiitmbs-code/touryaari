  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        <Link
          href="/admin/tours"
          className="p-2 text-stone hover:text-pine-dark hover:bg-cream rounded-lg transition-colors"
        >
          <ArrowLeft className="w-5 h-5" />
        </Link>
        <div>
          <h1 className="font-serif text-3xl font-bold text-pine-dark">Add New Tour</h1>
          <p className="text-stone mt-1">Create a new tour package</p>
        </div>
      </div>
              ...
              <button
                ...
                className={`px-6 py-4 text-sm font-medium transition-colors ${
                  activeTab === tab.id
                    ...
                    : 'text-stone hover:text-pine-dark'
                }`}
              >
                {tab.label}
              </button>
        ...
        <form onSubmit={handleSubmit} className="p-6">
          ...
          {activeTab === 'basic' && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-2.5 border border-cream-dark rounded-lg focus:border-gold focus:outline-none focus:ring-1 focus:ring-gold bg-white"
                  >
              ...
              <div>
                ...
                <p className="text-xs text-text-mid mt-1">Slug must match exactly: <strong>uttar-pradesh</strong> or <strong>uttarakhand</strong></p>
              </div>
              ...
              <div className="flex gap-6">
                <label className="flex items-center gap-2">
                  <input
                    ...
                    className="w-4 h-4 text-gold border-cream-dark rounded focus:ring-gold"
                  />
              ...
              <div>
                <div className="flex items-center justify-between mb-3">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1 text-sm text-gold hover:text-pine-dark"
                  >
          ...
          <div className="sticky bottom-0 bg-white pt-6 mt-6 border-t border-cream-dark flex items-center justify-between">
                ...
                <button
                  ...
                  className={`px-3 py-1.5 text-sm rounded-lg ${
                    activeTab === tab.id
                      ...
                      : 'bg-cream text-stone hover:bg-cream-dark'
                  }`}
                >
                  {tab.label}
                </button>
            ...
            <div className="flex gap-3">
              <Link
                href="/admin/tours"
                className="px-6 py-2.5 border border-cream-dark text-stone rounded-lg hover:bg-cream"
              >
                Cancel
              </Link>
              <button
